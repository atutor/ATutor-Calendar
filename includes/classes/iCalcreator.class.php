 ...
 */
  function _makeProdid() {
    $this->prodid  = '-//'.$this->unique_id.'//ATutor Calendar Module 1.0//'.strtoupper( $this->language );
  }
/**
 ...
 */
  function createDtend() {
    ...
    $formatted  = iCalUtilityFunctions::_format_date_time( $this->dtend['value'] )."Z";
 ...
 */
  function createDtstart() {
    ...
    $formatted  = iCalUtilityFunctions::_format_date_time( $this->dtstart['value'] )."Z";   
